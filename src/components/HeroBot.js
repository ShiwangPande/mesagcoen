    ...
    return (
        <div>
            <svg width="60vh" height="60vh" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 197.60004 221.93357">
                ...
                <g id="Big-Bg" class="hidden lg:block">
                    <path
                        id="Bg-1" class="hidden lg:block"
                ...
                <g id="Mid-Bg" class="hidden lg:block">
                    <path
                ...
                <g id="Small-Bg" class="hidden lg:block">
                    <path
